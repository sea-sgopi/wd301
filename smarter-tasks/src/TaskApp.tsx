...
const TaskApp = () => {
    ...
    const deleteTask = (index: number) => {
        setTaskAppState({ tasks: taskAppState.tasks.filter((_, i) => i !== index) });
    };

    return (
      <div className="container py-10 max-w-7xl mx-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="border border-slate-200 rounded-xl p-4">
            <h1 className="text-slate-500 text-xl font-bold text-center mb-8">
              Pending
            </h1>
